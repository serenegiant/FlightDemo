...
public class DualShock4 extends HIDParser {
	...
	protected void parse(final int n, final byte[] data) {
		...
		keyCount[KEY_RIGHT_C] = (d5 & 0x20) != 0 ? keyCount[KEY_RIGHT_C] + 1 : 0;
		keyCount[KEY_RIGHT_B] = (d5 & 0x40) != 0 ? keyCount[KEY_RIGHT_B] + 1 : 0;
		keyCount[KEY_RIGHT_A] = (d5 & 0x80) != 0 ? keyCount[KEY_RIGHT_A] + 1 : 0;
		// 右アナログスティックからデータを生成
