...
import com.serenegiant.widget.gl.TextureRegion;
...
public class RectangleBounds extends BaseBounds {
	 ...
	 * @param a
	 */
	public RectangleBounds(final float center_x, final float center_y, final TextureRegion region, final float a) {
		this(center_x, center_y, region.width * a, region.height * a);
	}
	 ...
	 */
	public RectangleBounds(final float center_x, final float center_y, final TextureRegion region, final float ax, final float bx) {
		this(center_x, center_y, region.width * ax, region.height * bx);
	}
	 ...
	 * @param region
	 */
	public RectangleBounds(final float center_x, final float center_y, final TextureRegion region) {
		this(center_x, center_y, region.width, region.height);
	}
