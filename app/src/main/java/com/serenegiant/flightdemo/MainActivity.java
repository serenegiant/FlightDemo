...
public class MainActivity extends ActionBarActivity implements ARDiscoveryServicesDevicesListUpdatedReceiverDelegate {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv.setText(R.string.drone_not_found);
		listView.setEmptyView(tv);

		deviceList = new ArrayList<ARDiscoveryDeviceService>();
		deviceNameList = new String[] {};

		final ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, android.R.id.text1, deviceNameList);
...
//			parser.Parse().jjtAccept(new ScriptParserVisitorImpl(), null);
	...
	private void initServices() {
		if (discoveryServiceBinder == null) {
			final Intent intent = new Intent(getApplicationContext(), ARDiscoveryService.class);
