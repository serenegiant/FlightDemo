...
//				final Vector calcValue = new Vector();		// roll,pitch,gaz制御量
...
//									// 制御コマンド送信
//									setMove(calcValue.x, calcValue.y, calcValue.z, pilotAngle);
//									// 今回の制御量を保存
//									if ((lostTime < 0) || (System.currentTimeMillis() - lostTime < 50)) {	// ラインを見失っても50ミリ秒以内なら保持する
//										mPrevPilotValue.set(calcValue);
//									}
//								} else {
//									// 制御コマンド送信
//									setMove(0.0f, 0.0f, calcValue.z, 0.0f);
//									mPrevPilotValue.set(0.0f, 0.0f, calcValue.z);
//								}
//							} else {
//								startTime = -1L;
//							}
//							final String m3 = String.format("p(%5.1f,%5.1f,%5.1f,%5.1f)", calcValue.x, calcValue.y, calcValue.z, pilotAngle);
