...
import com.serenegiant.math.RectangleBoundsEx;
...
//--------------------------------------------------------------------------------
	public void drawSprite(final RectangleBoundsEx bounds, final TextureRegion region) {
...
//--------------------------------------------------------------------------------
	public void drawSprite(final RectangleBoundsEx bounds, final TextureRegion region, final float aspect) {
...
//--------------------------------------------------------------------------------
	public void drawSprite(final RectangleBoundsEx bounds, final TextureRegion region, final float aspect_width, final float aspect_height) {
