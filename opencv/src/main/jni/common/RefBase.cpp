...
void RefBase::incStrong(const void* id) const
{
    ...
    const int32_t c = __atomic_inc(&refs->mStrong);/*android_atomic_inc(&refs->mStrong);*/
    ...
    __atomic_add(-INITIAL_STRONG_VALUE, &refs->mStrong);/*android_atomic_add(-INITIAL_STRONG_VALUE, &refs->mStrong);*/
...
void RefBase::decStrong(const void* id) const
{
    ...
    const int32_t c = __atomic_dec(&refs->mStrong);/*android_atomic_dec(&refs->mStrong);*/
#if PRINT_REFS
...
void RefBase::weakref_type::incWeak(const void* id)
{
    ...
    impl->addWeakRef(id);
    const int32_t c = __atomic_inc(&impl->mWeak);/*android_atomic_inc(&impl->mWeak);*/
...
void RefBase::weakref_type::decWeak(const void* id)
{
    ...
    const int32_t c = __atomic_dec(&impl->mWeak);/*android_atomic_dec(&impl->mWeak);*/
...
//				if (android_atomic_cmpxchg(curCount, curCount + 1, &impl->mStrong) == 0) {
            ...
            // extended life-time.
            curCount = __atomic_inc(&impl->mStrong);/*android_atomic_inc(&impl->mStrong);*/
        }
    ...
    while (curCount >= INITIAL_STRONG_VALUE) {
        LOG_ASSERT(curCount > INITIAL_STRONG_VALUE,
                "attemptIncStrong in %p underflowed to INITIAL_STRONG_VALUE", this);
//		if (android_atomic_cmpxchg(curCount, curCount-INITIAL_STRONG_VALUE, &impl->mStrong) == 0) {
		if (__atomic_cmpxchg(curCount, curCount-INITIAL_STRONG_VALUE, &impl->mStrong) == 0) {
            break;
        }
