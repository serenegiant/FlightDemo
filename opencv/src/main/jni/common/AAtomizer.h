...
#include "ABase.h"			// #include <media/stagefright/foundation/ABase.h>
#include "AString.h"		// #include <media/stagefright/foundation/AString.h>
#include "List.h"			// #include <utils/List.h>
#include "Vector.h"			// #include <utils/Vector.h>
							//#include <utils/threads.h>
#include "Mutex.h"

using namespace android::sysutils;
namespace android {
