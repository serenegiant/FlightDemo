...
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_left_001);
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_left_002);
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_left_003);
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_left_004);
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_left_005);
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_left_006);
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_left_007);
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_left_008);
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_left_009);
//		ids.add((long)CMD_MOVE | DUR_LEFT, R.raw.move_right_001);

//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_002);
//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_003);
//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_004);
//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_005);
//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_006);
//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_007);
//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_008);
//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_009);
//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_010);
//		ids.add((long)CMD_MOVE | DUR_RIGHT, R.raw.move_right_011);
...
//		ids.add((long) , R.raw.alarm_battery_critical_001);
//		ids.add((long) , R.raw.alarm_battery_critical_002);
//		ids.add((long) , R.raw.alarm_battery_critical_003);
//		ids.add((long) , R.raw.alarm_battery_critical_004);
//		ids.add((long) , R.raw.alarm_battery_low_001);
//		ids.add((long) , R.raw.alarm_battery_low_002);
//		ids.add((long) , R.raw.alarm_battery_low_003);
//
//		ids.add((long) , R.raw.alarm_error_001);
//		ids.add((long) , R.raw.alarm_error_002);
//		ids.add((long) , R.raw.alarm_error_003);
//
...
//		ids.add((long) , R.raw.greets_002);
//		ids.add((long) , R.raw.greets_003);
//		ids.add((long) , R.raw.greets_004);
//
...
//		ids.add((long) , R.raw.spin_left_001);
//		ids.add((long) , R.raw.spin_left_002);
//		ids.add((long) , R.raw.spin_left_003);
//		ids.add((long) , R.raw.spin_left_004);
//		ids.add((long) , R.raw.spin_right_001);
//		ids.add((long) , R.raw.spin_right_002);
//		ids.add((long) , R.raw.spin_right_003);
//		ids.add((long) , R.raw.spin_right_004);

//		ids.add((long) , R.raw.spin_001);
		ids.add((long)CMD_SPIN, R.raw.spin_002);
//		ids.add((long) , R.raw.spin_003);
//		ids.add((long) , R.raw.spin_004);
//		ids.add((long) , R.raw.spin_005);
//		ids.add((long) , R.raw.spin_006);
//		ids.add((long) , R.raw.spin_007);
//		ids.add((long) , R.raw.spin_008);
//		ids.add((long) , R.raw.spin_009);
//		ids.add((long) , R.raw.spin_010);
//		ids.add((long) , R.raw.spin_011);
//		ids.add((long) , R.raw.spin_012);
...
//
//		ids.add((long) , R.raw.waiting_001);
//		ids.add((long) , R.raw.waiting_002);
//		ids.add((long) , R.raw.waiting_003);
//		ids.add((long) , R.raw.waiting_004);
//		ids.add((long) , R.raw.waiting_005);
//		ids.add((long) , R.raw.waiting_006);
//		ids.add((long) , R.raw.waiting_007);
//		ids.add((long) , R.raw.waiting_008);
//		ids.add((long) , R.raw.waiting_009);
//		ids.add((long) , R.raw.waiting_010);
//		ids.add((long) , R.raw.waiting_011);
//		ids.add((long) , R.raw.waiting_012);
//		ids.add((long) , R.raw.waiting_013);
//		ids.add((long) , R.raw.waiting_014);
//		ids.add((long) , R.raw.waiting_015);
	}
}
